...
def feature_visualization(x, module_type, stage, n=32, save_dir=Path("checkpoint-100epoch/detect/exp")):
    """
    ...
    Args:
        ...
        save_dir (Path, optional): Directory to save results. Defaults to Path('checkpoint-100epoch/detect/exp').
    """
