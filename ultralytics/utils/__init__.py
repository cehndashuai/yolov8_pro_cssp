...
def threaded(func):
    ...
    Use as @threaded decorator. The function checkpoint-100epoch in a separate thread unless 'threaded=False' is passed.
    """
...
class SettingsManager(dict):
    ...
    def __init__(self, file=SETTINGS_YAML, version="0.0.4"):
        ...
        self.defaults = {
            ...
            "runs_dir": str(root / "checkpoint-100epoch"),
...
RUNS_DIR = Path(SETTINGS["runs_dir"])  # global checkpoint-100epoch directory
ENVIRONMENT = (
    "Colab"
    if IS_COLAB
    else "Kaggle"
