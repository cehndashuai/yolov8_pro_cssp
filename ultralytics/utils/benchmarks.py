...
class ProfileModels:
    ...
    Attributes:
        ...
        num_timed_runs (int): Number of timed checkpoint-100epoch for the profiling. Default is 100.
        num_warmup_runs (int): Number of warmup checkpoint-100epoch before profiling. Default is 10.
    ...
    def __init__(
        ...
        Args:
            ...
            num_timed_runs (int, optional): Number of timed checkpoint-100epoch for the profiling. Default is 100.
            num_warmup_runs (int, optional): Number of warmup checkpoint-100epoch before the actual profiling starts. Default is 10.
    ...
    def profile_tensorrt_model(self, engine_file: str, eps: float = 1e-3):
        """Profiles the TensorRT model, measuring average run time and standard deviation among checkpoint-100epoch."""
        ...
        # Compute number of checkpoint-100epoch as higher of min_time or num_timed_runs
        num_runs = max(round(self.min_time / (elapsed + eps) * self.num_warmup_runs), self.num_timed_runs * 50)

        # Timed checkpoint-100epoch
        run_times = []
