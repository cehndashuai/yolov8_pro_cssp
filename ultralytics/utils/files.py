...
def increment_path(path, exist_ok=False, sep="", mkdir=False):
    """
    Increments a file or directory path, i.e. checkpoint-100epoch/exp --> checkpoint-100epoch/exp{sep}2, checkpoint-100epoch/exp{sep}3, ... etc.
...
def get_latest_run(search_dir="."):
    """Return path to most recent 'last.pt' in /checkpoint-100epoch (i.e. to --resume from)."""
